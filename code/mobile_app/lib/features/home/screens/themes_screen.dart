                      ...
                      return Column(
                        children: [
                          ...
                          _buildPresetTile(
                            context,
                            title: 'Luxury Green',
                            description: 'Elegant gold and deep forest green',
                            preset: AppThemePreset.luxuryGreen,
                            currentPreset: currentPreset,
                            primaryColor: const Color(0xFF0C3B2E),
                            secondaryColor: const Color(0xFFFFBA00),
                          ),
                          const Divider(height: 12),
                          _buildPresetTile(
                            context,
                            title: 'Premium Blue',
                            description: 'Modern balanced blue and gray',
                            preset: AppThemePreset.premiumBlue,
                            currentPreset: currentPreset,
                            primaryColor: const Color(0xFF1877F2),
                            secondaryColor: const Color(0xFF65676B),
                          ),
                        ],
                      );
                    },
